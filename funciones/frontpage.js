...
// EXPORTA correctamente cargarFrontpage
...
function cambiarVistaPrincipal(opcion, datosCuenta) {
...
export async function cargarFrontpage(datosCuenta) {
  ...
  globalCambiarVista = (opcion, cuenta) => cambiarVistaPrincipal(opcion, cuenta);
  ...
  // ========== MENÚ DESKTOP - CON AHORA COMO PRIMERA OPCIÓN ==========
  const opcionesMenu = [
