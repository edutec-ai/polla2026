            ...
            <tbody>${
                equiposGrupo.map((eq, idx) => {
                    ...
                    return `<tr style="background:${idx % 2 === 0 ? '#fff' : '#f9f9f9'}">
                        ...
                        <td>${eq.pj||0}</td><td style="color:${eq.pg>0?'#34c759':'#1c1c1e'}">${eq.pg||0}</td><td style="color:${eq.pe>0?'#ff9500':'#1c1c1e'}">${eq.pe||0}</td><td style="color:${eq.pp>0?'#ff3b30':'#1c1c1e'}">${eq.pp||0}</td>
                        <td>${eq.gf||0}</td><td>${eq.gc||0}</td><td style="color:${(eq.dif||0)>0?'#34c759':(eq.dif||0)<0?'#ff3b30':'#1c1c1e'}">${(eq.dif||0)>0?'+'+eq.dif:eq.dif||0}</td>
