...
export async function renderizarAhora(contenedor, datosCuenta) {
    ...
    if (esAntesDeInauguracion()) {
        ...
        // Intervalo para actualizar badges cada 60 segundos (sin re-renderizar todo)
